...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost:5000/login', allinfo);
                ...
                <div className="hero-content w-full">
                    <div className="bg-[#7d66ff] w-full max-w-sm">
                        <div className="p-4">
                            ...
                            <h1 className="text-4xl font-bold text-yellow-400 mt-7 text-center">Login</h1>
                        </div>
                        <form onSubmit={handleSubmit} className="card-body bg-[#7d66ff] space-y-7">
                            ...
                            <div className="form-control mt-6">
                                <button className="py-3 hover:bg-yellow-600 bg-yellow-500 text-black text-xl">Login</button>
                            </div>
                            <h1 className='text-xl font-bold'>Have Account <Link className='text-blue-100' to="/register">Register Now</Link></h1>
                        </form>
                    </div>
                </div>
            </div>
